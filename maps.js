...
$(document).ready(function() {
    ...
    wait().then(function(){
        var water_points = {
            draw: function(){
                var location_001={lat: 28.942361, lng:  -98.486939}
                var point_001 = new google.maps.Marker({
                    position: location_001,
                    title: "Stuart Pressure Control"
                });
                point_001.setMap(map);             
                
                 var location_002={lat: 28.940629, lng: -98.483645} 
                 ...
                 var location_003={lat: 28.939002, lng:-98.511267}  
                 var point_003 = new google.maps.Marker({
                     position: location_003,
                     title: "Riata Dry Cleaners"
                 });
                 point_003.setMap(map); 
                
                 var location_004={lat: 28.960586, lng:-98.485500}  
